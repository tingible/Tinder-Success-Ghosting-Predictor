...
# Load data
df = pd.read_csv('vader_merged_everything_overall_finalsample_streamlit.csv')
...
input_feature = pd.DataFrame([[Attractiveness_indicator, Num_messages, Message_word_count, Positive_percent]],
